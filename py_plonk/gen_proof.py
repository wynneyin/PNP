...
from .arithmetic import INTT,from_coeff_vec,resize,\
                        from_gmpy_list,from_list_gmpy,from_list_tensor,from_tensor_list,from_list_gmpy_1,from_coeff_vec_list,domian_trans_tensor
from .load import read_scalar_data,read_scalar_data_new
...
def gen_proof(pp, pk: Prover_Key, cs: StandardComposer, transcript: transcript.Transcript):
    ...
    Fr1=torch.zeros(1,4,dtype=torch.BLS12_381_Fr_G1_Mont)
    #get FFT domaim
    ...
    w_l_scalar=read_scalar_data_new("py_plonk/w_l_scalar.txt")
    w_r_scalar=read_scalar_data_new("py_plonk/w_r_scalar.txt")
    w_o_scalar=read_scalar_data_new("py_plonk/w_o_scalar.txt")
    w_4_scalar=read_scalar_data_new("py_plonk/w_4_scalar.txt")
    ...
    h_1_poly = from_coeff_vec(h_1_temp)  #####tensor
    h_2_poly = from_coeff_vec(h_2_temp)  #####tensor
