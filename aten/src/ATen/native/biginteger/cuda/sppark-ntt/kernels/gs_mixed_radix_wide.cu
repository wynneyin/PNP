...
#ifdef __CUDA_ARCH__
        t = BLS12_381_Fr_G1::csel(r1, r0, pos);
        __syncthreads();
          ...
          const cudaStream_t& stream, int* stage)
{
    ...
    case 6:
        ...
        case 18:
            ...
            d_intermediate_twiddles = radix_middles + 64*64; //radix6_twiddles_12
            _GS_NTT<2><<<NTT_CONFIGURATION>>>(NTT_ARGUMENTS);
            break;
        default:
    ...
    case 7:
        ...
        case 14:
            ...
            d_intermediate_twiddles = radix_middles + 64*64+4096*64; //radix7_twiddles_7
            _GS_NTT<2><<<NTT_CONFIGURATION>>>(NTT_ARGUMENTS);
            break;
        default:
            _GS_NTT<1><<<NTT_CONFIGURATION>>>(NTT_ARGUMENTS);
