...
// TORCH_API std::vector<torch::lazy::Shape> compute_shape_params_zkp(at::TensorList params, int64_t gpu_id, bool is_intt);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_intt_coset_zkp(const at::Tensor & self, at::TensorList params);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_intt_zkp(const at::Tensor & self, at::TensorList params);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_ntt_coset_zkp(const at::Tensor & self, at::TensorList params);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_ntt_zkp(const at::Tensor & self, at::TensorList params);
// Non-Native ops
