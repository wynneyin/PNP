...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_intt_coset_zkp(const at::Tensor & self, const at::Tensor & params);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_intt_zkp(const at::Tensor & self, const at::Tensor & params);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_ntt_coset_zkp(const at::Tensor & self, const at::Tensor & params);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_ntt_zkp(const at::Tensor & self, const at::Tensor & params);
// Non-Native ops
