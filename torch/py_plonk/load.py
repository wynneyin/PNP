    ...
    for line in lines:
        if line.endswith(":"):
            ...
            if current_section == "powers_of_g":
                x_str = values[1]
                y_str = values[2]
                G1_point= AffinePointG1(x=fq.Fq(value=parse_bigint(x_str,fq.Fq.Limbs)),y=fq.Fq(value=parse_bigint(y_str,fq.Fq.Limbs)))
                ...
                h.x.c0 = fq.Fq(value=parse_bigint(values[1],fq.Fq.Limbs))
                h.x.c1 = fq.Fq(value=parse_bigint(values[2],fq.Fq.Limbs))
                h.y.c0 = fq.Fq(value=parse_bigint(values[3],fq.Fq.Limbs))
                h.y.c1 = fq.Fq(value=parse_bigint(values[4],fq.Fq.Limbs))
                
            elif current_section == "beta_h":
                beta_h.x.c0 = fq.Fq(value=parse_bigint(values[1],fq.Fq.Limbs))
                beta_h.x.c1 = fq.Fq(value=parse_bigint(values[2],fq.Fq.Limbs))
                beta_h.y.c0 = fq.Fq(value=parse_bigint(values[3],fq.Fq.Limbs))
                beta_h.y.c1 = fq.Fq(value=parse_bigint(values[4],fq.Fq.Limbs))
...
def read_cs_data(filename):
    ...
    for line in lines[3:-2]:
        ...
        if line.endswith(":"):
            ...
            value = parse_bigint(line,fr.Fr.Limbs)
