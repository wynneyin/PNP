...
class fp2_t {
 ...
 public:
  ...
  inline fp2_t& operator+=(const fp2_t& b) {
    add_mod_384x(val, val, b.val, BLS12_381_P);
    return *this;
  }
  friend inline fp2_t operator+(const fp2_t& a, const fp2_t& b) {
    fp2_t ret;
  ...
  inline fp2_t& operator-=(const fp2_t& b) {
    sub_mod_384x(val, val, b.val, BLS12_381_P);
    return *this;
  }
  friend inline fp2_t operator-(const fp2_t& a, const fp2_t& b) {
    fp2_t ret;
  ...
  inline fp2_t& operator*=(const fp2_t& a) {
    if (this == &a)
      ...
      mul_mont_384x(val, val, a.val, BLS12_381_P, p0);
    return *this;
  }
  friend inline fp2_t operator*(const fp2_t& a, const fp2_t& b) {
    fp2_t ret;
    if (&a == &b)
      ...
      mul_mont_384x(ret.val, a.val, b.val, BLS12_381_P, p0);
    return ret;
  }
